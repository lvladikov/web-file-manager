...
export default function useCopyPaths({ setError, activePanel, panels, selections, setCopyPathsModal, wsRef }) {
        ...
        jobWs.onmessage = (event) => {
          ...
          switch (data.type) {
            ...
            case "complete":
              ...
              setCopyPathsModal({ isVisible: false, jobId: null, currentPath: "", count: 0, mode: "Clipboard" });
              break;
            case "error":
