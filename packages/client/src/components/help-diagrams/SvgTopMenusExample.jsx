...
const SvgTopMenusExample = () => (
  <SvgUiElement width={400} height={280}>
    {/* Menu Bar */}
    <rect x="10" y="10" width="380" height="30" fill="#4b5563" />
    <text x="20" y="30" className="svg-text svg-text-bold">File</text>
    <text x="100" y="30" className="svg-text svg-text-bold">Select</text>

    {/* File Dropdown */}
    <rect x="10" y="40" width="180" height="230" rx="4" fill="#374151" className="svg-border" />
    ...
    <line x1="10" y1="110" x2="190" y2="110" className="svg-border" />
    ...
    <line x1="10" y1="180" x2="190" y2="180" className="svg-border" />
    <text x="20" y="200" className="svg-text">Rename (F2)</text>
    <text x="20" y="220" className="svg-text" fill="#F87171">Delete (F8)</text>
    <line x1="10" y1="230" x2="190" y2="230" className="svg-border" />
    <text x="20" y="250" className="svg-text">Calculate folder size</text>
    <text x="20" y="270" className="svg-text">Refresh active panel</text>
